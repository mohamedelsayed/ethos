...
$year_groups = array('Preschool', 'FS1', 'FS2', 'Year 1', 'Year 2', 'Year 3', 'Year 4', 'Year 5', 'Year 6', 'Year 7', 'Year 8');
...
<div class="input_new">
    <label for="year_group_applying_to_input">Year group applied for:</label>
    <span>
    ...
    <div class="additional_pupils_informations-table">
        <table border="1">
            ...
            for ($i = 1; $i <= 5; $i++) {
                ...
                <tr>
                    <?php for ($j = 1; $j <= 4; $j++) { ?>
                        <td><input class="additional_pupils_informations input_in_table <?php echo $required_input_class; ?>" id="previous_schools_nursery_<?php echo $i . '_' . $j; ?>" type="text" name="previous_schools_nursery_<?php echo $i . '_' . $j; ?>" value="" placeholder=""></td>
                    <?php } ?>
                </tr>
            <?php } ?>
        </table>
...
<div class="send_form">
    <input class="Send white_green_button btn_form_admissions" type="submit" id="send_form_admissions" value="Send" />
</div>
