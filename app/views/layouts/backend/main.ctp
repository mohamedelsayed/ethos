                ...
                <div class="content_left">
                    ...
                    <?php if (($this->action != 'login') && ($this->action != 'forgot')) { ?>
                        <div class="title" style="margin-top: 0;">
                            ...
                            <div class="hellohome">
                                <?php
                                echo 'Hello, ' . $this->Session->read('userInfo.User.name') . ': ';
                                echo $this->Html->link(
                                        $this->Html->image('backend/settings2.jpeg', array('title' => __('Settings', true), 'border' => '0')), array('controller' => 'settings/edit'), array('escape' => false)
                                );
                                echo $this->Html->link(
                                        $this->Html->image('backend/home.jpeg', array('title' => __('Home', true), 'border' => '0')), array('controller' => 'me-admin/index'), array('escape' => false)
                                );
                                echo $this->Html->link(
                                        $this->Html->image('backend/logout2.jpeg', array('title' => __('logout', true), 'border' => '0')), array('controller' => 'me-admin/logout'), array('escape' => false)
                                );
                                ?>
                            </div>
                        </div>
