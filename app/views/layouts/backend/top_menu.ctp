    ...
    <?php if (($this->action != 'login') && ($this->action != 'forgot')) { ?>
        <div id="dropdown-holder">
            <ul id="nav" class="dropdown">
                ...
                <?php /*<li class="heading"><a href="<?php echo $this->Session->read('Setting.url') . '/widgets'; ?>"><?php echo __('Widgets'); ?></a></li>*/ ?>
                <?php /* <li class="heading"><a href="<?php echo $this->Session->read('Setting.url').'/academics';?>">Academics</a></li> */ ?>
                <?php /*<li class="heading"><a><?php echo __('Media'); ?></a>
                    <ul>
                ...
                <?php /*<li class="heading"><a><?php echo __('Events'); ?></a>
                    <ul>
                ...
                <?php
                /*$contents = $this->requestAction('main/getContents');
                ...
                <?php }*/ ?>
<?php /*                <li class="heading"><a href="<?php echo $this->Session->read('Setting.url') . '/testimonials'; ?>"><?php echo __('Testimonials'); ?></a></li>
                ...
                <?php /**/ ?>
                <?php /*<li class="heading"><a><?php echo __('Newsletter System'); ?></a>
                    <ul>
                ...
                <?php /*<li class="heading"><a href="<?php echo $this->Session->read('Setting.url') . '/orientations/edit/1'; ?>"><?php echo __('Orientation'); ?></a></li>*/?>
            </ul>
        </div>
    <?php } ?>
</div>
