...
<html lang="en-US">
    ...
    <head>
        ...
        echo $this->Javascript->link(array('front/jquery', 'front/jMenu.jquery', 'front/jquery.jcarousel.min', 'front/dev'));
        ...
        <meta name="google-site-verification" content="j9XmtgqY62wxpvYJGKAaDzxJYYHqrqOdklh82kReuWU" />
                        ...
                        <div class="slider_main_div">
                            ...
                            <div class="slider_main">
                                <div class="wrie_pic" style="width: 60%;margin-left: 20%;margin-right:20%;">
                                    <?php
                                    $body = $this->element('front' . DS . 'view_string_according_lang', array('str_en' => $data['body'], 'str_ar' => $data['body_ar']));
