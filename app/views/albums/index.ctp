<div class="events index">
    <?php echo $this->element('backend/search_view', array('currentModel' => 'Album', 'currentField' => 'title')); ?>
    <h2><?php __('Albums'); ?></h2>
    <table cellpadding="0" cellspacing="0">
        ...
        foreach ($albums as $album):
            ...
            <tr<?php echo $class; ?>>
                ...
                <td><?php echo strip_tags($album['Album']['title']); ?>&nbsp;</td>
                <td><?php if ($album['Album']['approved'] == 1)
            echo 'Yes';
        elseif ($album['Album']['approved'] == 0)
            echo 'No';
            ?>&nbsp;</td>
                <td class="actions">
