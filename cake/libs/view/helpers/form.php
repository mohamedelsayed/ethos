...
class FormHelper extends AppHelper {
    ...
    function button($title, $options = array()) {
        ...
        return sprintf(
                $this->Html->tags['button'], $options['type'], $this->_parseAttributes($options, array('type'), ' ', ''), $title
        );
    }
    ...
    function submit($caption = null, $options = array()) {
        ...
        if (strpos($caption, '://') !== false) {
            ...
            $out .= $before . sprintf(
                            $this->Html->tags['submitimage'], $this->assetTimestamp($url), $this->_parseAttributes($options, null, '', ' ')
                    ) . $after;
        } else {
    ...
    function select($fieldName, $options = array(), $selected = null, $attributes = array()) {
        ...
        $select = array_merge($select, $this->__selectOptions(
                        array_reverse($options, true), $selected, array(), $showParents, array('escape' => $escapeOptions, 'style' => $style, 'name' => $attributes['name'], 'class' => $attributes['class'])
        ));
    ...
    function year($fieldName, $minYear = null, $maxYear = null, $selected = null, $attributes = array()) {
        ...
        return $this->select(
                        $fieldName . '.year', $this->__generateOptions('year', $yearOptions), $selected, $attributes
        );
    }
    ...
    function month($fieldName, $selected = null, $attributes = array()) {
        ...
        return $this->select(
                        $fieldName . ".month", $this->__generateOptions('month', array('monthNames' => $monthNames)), $selected, $attributes
        );
    }
    ...
    function hour($fieldName, $format24Hours = false, $selected = null, $attributes = array()) {
        ...
        return $this->select(
                        $fieldName . ".hour", $this->__generateOptions($format24Hours ? 'hour24' : 'hour'), $selected, $attributes
        );
    }
    ...
    function minute($fieldName, $selected = null, $attributes = array()) {
        ...
        return $this->select(
                        $fieldName . ".min", $this->__generateOptions('minute', $minuteOptions), $selected, $attributes
        );
    }
    ...
    function meridian($fieldName, $selected = null, $attributes = array()) {
        ...
        return $this->select(
                        $fieldName . ".meridian", $this->__generateOptions('meridian'), $selected, $attributes
        );
    }
